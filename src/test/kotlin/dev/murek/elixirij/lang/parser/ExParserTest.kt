...
class ExParserTest : ParsingTestCase(
    ...
    fun testGrill1() = doTest()
    fun testGrill2() = doTest()
    fun testGrill3() = doTest()
    fun testGrill4() = doTest()
    fun testGrill5() = doTest()
    fun testGrill6() = doTest()
    fun testGrill7() = doTest()
    fun testGrill8() = doTest()
    fun testGrill9() = doTest()
    fun testGrill10() = doTest()
